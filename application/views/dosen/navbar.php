...
<head>
  ...
  <title>Dosen Bimbingan Akademik</title>
...
<body class="hold-transition skin-green-light sidebar-mini">
  <header class="main-header">
    ...
    <a href="<?php echo base_url() ?>dosen/" class="logo">
      ...
      <span class="logo-mini"><b>Dosen</b></span>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo $nama_member; ?></span>
            </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url() ?>dosen/profile" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a href="<?php echo base_url() ?>authmember/logout" class="btn btn-primary">Logout</a>
        </div>
        </form>
      </div>
    </div>
