...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Bimbingan UTS</li>
        </ol>
    </section>
                        ...
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                foreach ($uts as $data) { ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <div class="text-center">
                                                    <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#edit-<?= $data->id_uts; ?>" title="Edit UTS"><span class="fa fa-edit"></span></a>
                                                    <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete-<?= $data->id_uts; ?>" title="Delete UTS"><span class="fa fa-trash"></span></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="edit-<?= $data->id_uts; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title">Edit Bimbingan UTS</h4>
                                                </div>

                                                <form action="<?php echo base_url() ?>dosen/edit_uts" method="POST">
                                                    <input type="hidden" name="id_uts" value="<?= $data->id_uts; ?>">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="delete-<?= $data->id_uts; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title">Hapus Bimbingan UTS</h4>
                                                </div>

                                                <form action="<?php echo base_url() ?>dosen/delete_uts" method="POST">
                                                    <div class="modal-body">
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Tambah Bimbingan UTS</h4>
                </div>

                <form id="form_add_uts" action="<?php echo base_url() ?>dosen/add_uts" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="email">Nama Mahasiswa</label>
