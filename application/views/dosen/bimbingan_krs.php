...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Data Bimbingan KRS</li>
        </ol>
    </section>
                        ...
                        <table id="example" class="display" style="width:100%">
                            ...
                            <tbody>
                                ...
                                foreach ($krs as $data) { ?>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <div class="text-center">
                                                    <a href="#" class="btn btn-warning" data-toggle="modal" data-target="#edit-<?= $data->id_krs; ?>" title="Edit KRS"><span class="fa fa-edit"></span></a>
                                                    <a href="#" class="btn btn-danger" data-toggle="modal" data-target="#delete-<?= $data->id_krs; ?>" title="Delete KRS"><span class="fa fa-trash"></span></a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="edit-<?= $data->id_krs; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title">Edit Bimbingan KRS</h4>
                                                </div>

                                                <form action="<?php echo base_url() ?>dosen/edit_krs" method="POST">
                                    ...
                                    <!-- Modal -->
                                    <div class="modal fade" id="delete-<?= $data->id_krs; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    <h4 class="modal-title">Hapus Bimbingan KRS</h4>
                                                </div>

                                                <form action="<?php echo base_url() ?>dosen/delete_krs" method="POST">
                                                    <div class="modal-body">
    ...
    <div class="modal fade" id="add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Tambah Bimbingan KRS</h4>
                </div>

                <form id="form_add_krs" action="<?php echo base_url() ?>dosen/add_krs" method="POST">
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="email">Nama Mahasiswa</label>
